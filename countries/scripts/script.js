    ...
    try {
        ...
        resultDiv.innerHTML = `
            <div class="country-card">
                ...
                <h2>${country.flag} ${country.name.common} <span class="star" onclick="toggleStar('${country.name.common}', '${languages.replace(/'/g, "\\'")}')" data-country="${country.name.common}">☆</span></h2>
